...
public class Interface extends JFrame {
	...
	public static int[] IndicesOriginais;
	 //Tamahos do atributos CFT
    public static int CorSize = 0;
    public static int FormaSize = 0;
    public static int TamanhoSize = 0;
	//PainelIFC Interno
	...
	public Interface()
    {
        ...
        //Inicializando o tamanho da tela
   	   WidthScreen = (int) Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100 * 95; //1280
   	   HeightScreen =(int) Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100 * 95; //800
...
//Seta o módulo de visualização disposto na área de visualização
          ...
          Quadrant1 = new JButton("1");
          Quadrant2 = new JButton("2");
          Quadrant3 = new JButton("3");
          Quadrant4 = new JButton("4");
          Quadrant5 = new JButton("5");
          Quadrant6 = new JButton("6");
          Quadrant7 = new JButton("7");
          Quadrant8 = new JButton("8");
...
//  		ScreenInternalH = HeightScreen/6; //Tava Funcionando com esse aqui 
  		...
  		ScreenInternalX = (int) WidthScreen/100 * 10; 
  		ScreenInternalY = (int) HeightScreen/100 * 95;
...
//  		Anterior.setEnabled(false);
  		...
  		Interagir.setEnabled(false);
                ...
                Font f = new Font(Interagir.getFont().getFontName(),Font.PLAIN,18);
                Interagir.setFont(f);
...
//                                IndicesOriginais[mark] = i;
	...
	public static JDesktopPane PainelIFC() throws GrammarException, EngineStateError, IOException{ // Interagir Filtrar e Configurar
		...
		painelIFC.setLocation(ScreenInternalX, ScreenInternalY); //retirar o 20 para ficar só os eixos XYZ
	...
	public static void BtnsIFC(){
                ...
                int 
		ButtonW = ScreenInternalW/4, ButtonH = ScreenInternalH/4,
		ButtonX = ScreenInternalX/2, ButtonY = ScreenInternalY+ScreenInternalY/8;  //Ajustar em 8(tirar o 10 e subistuir) para o Linux
...
//                
	...
	public static void BtnFiltrarCategorico(String[] s){
		...
		for(int i = 0; i <= s.length-1;i++){
            ...
            // BtnListener.FiltrarCategoricos = true;
	}
...
//		LimparPainel(desktopIFC);
		...
		painelIFC.setTitle("Detalhes Sobre Demanda");
          ...
          if (Vis3D.QtdPontosVisuais > 10) {
              ...
              if (infoVisModule.IsPlot3D) {
        Quadrant1.setSize(ButtonW/2,ButtonH); 
		Quadrant1.setLocation(ButtonX + ButtonW/2, ButtonY - (ButtonY/50)* 4);
                
		Quadrant2.setSize(ButtonW/2,ButtonH); 
//		Quadrant2.setLocation(ButtonX + 3*ButtonW  ,ButtonY - (ButtonY/50)* 4);
		...
		Quadrant3.setSize(ButtonW/2,ButtonH); 
//		Quadrant3.setLocation(ButtonX + ButtonW/2, ButtonY - ButtonY/50);
		Quadrant3.setLocation(ButtonX + ButtonW/2, ButtonY - ButtonY/50);
                
		Quadrant4.setSize(ButtonW/2,ButtonH); 
