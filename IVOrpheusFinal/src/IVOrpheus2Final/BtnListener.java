...
public class BtnListener implements ActionListener, MenuListener, MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public static boolean MoverGirar = false, Redimensionar = false, ConfigurarBool = false, FiltrarBool = false, Inicio = false, Fim = false,
            PrimeiroNumeroInicio = true, PrimeiroNumeroFim = true, ConfigurarCor = false, FiltrarCor = false, ConfigurarForma = false, FiltrarForma = false, ConfigurarTamanho = false, FiltrarTamanho = false; // true para mover e false para girar
...
//                EscalaValor += 0.2;
//            }
//            Interface.plot3D.setDefaultZoom(EscalaValor);
...
//            if (MoverGirar) {
//                Interface.plot3D.move(Interface.plot3D.getX() + 10, Interface.plot3D.getY() + 10);

//            } else {
//                Interface.plot3D.rotate(Interface.plot3D.getX() + 1, Interface.plot3D.getY());
...
//            } else {
            ...
            (new ThreadInteraction()).start();
//                Interface.plot3D.rotate(Interface.plot3D.getX() + 10, Interface.plot3D.getY() + 10);
//            }
        } else if (acao.getSource() == Interface.Cima) {
//            if (MoverGirar) {
//                Interface.plot3D.move(Interface.plot3D.getX(), Interface.plot3D.getY() - 10);
//            } else {
            ThreadInteraction.Cima();
            (new ThreadInteraction()).start();
//                Interface.plot3D.rotate(0, 2);
//            }
...
//            if (MoverGirar) {
//				Interface.plot3D.move(Interface.plot3D.getX()-10, Interface.plot3D.getY());	
//                Interface.plot3D.setLocation(Interface.plot3D.getX() - 10, Interface.plot3D.getY());
//                                Interface.painelInteragir.setLocation(Interface.plot3D.getX(), Interface.plot3D.getY());

//            } else {
            ThreadInteraction.Esquerda();
            (new ThreadInteraction()).start();
//                while(true){
//                Interface.plot3D.rotate(-0.01, 0);
//                }
//            }
...
//                            Reconhecedor.GramFiltrar();
            ...
            /*EixoXTradutor = true;
             ...
             IMATVI.Interface.BaseFC(Main.att.GetFileAttributes());
             Main.Interface.setContentPane(((IMATVI.Interface)Main.Interface).PainelCarregar());
             } catch (GrammarException e) {
             // TODO Auto-generated catch block
             e.printStackTrace();
             } catch (EngineStateError e) {
