...
public class Reconhecedor extends ResultAdapter {
	...
	gramFC,gramDAtributos,gramTemp,gramFiltrar;
...
//			FileReader readerCarregar = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/DCarregar.grammar");
			FileReader readerCarregar = new FileReader("/Users/lennonsalesfurtado/NetBeansProjects/Lyra/src/Gramaticas/DCarregar.grammar");
			FileReader readerIFC = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/IFC.grammar");
			FileReader readerInteragir = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/Interagir.grammar");
			FileReader readerMG = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/MG.grammar");
			FileReader readerEscala = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/Escala.grammar");
			FileReader readerFC = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/FC.grammar");
			FileReader readerAtributos = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/DAtributos.grammar");
			FileReader readerFiltrar = new FileReader(System.getProperty("user.home")+"/workspace/MyCalcJLAPSAPI/Filtrar.grammar");	
